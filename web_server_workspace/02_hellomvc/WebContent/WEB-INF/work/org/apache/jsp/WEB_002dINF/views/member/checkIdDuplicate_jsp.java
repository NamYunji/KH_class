 ...
 * Generated at: 2021-04-04 15:54:22 UTC
...
public final class checkIdDuplicate_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(available) { 
      ...
      out.write(" * 2. #idValid의 값을 1로 변경\r\n");
      out.write(" */\r\n");
      out.write("function setMemberId() {\r\n");
      out.write("\t// 부모윈도우 opener 키워드로 접근\r\n");
      out.write("\t// $frm - memberEnroll.jsp(부모윈도우)의 memberEnrollFrm\r\n");
      out.write("\t// opener는 window객체\r\n");
      out.write("\tvar $frm = $(opener.document.memberEnrollFrm);\r\n");
      out.write("\t// 1. memberId_의 value값에 현재 ok받은 memberId값으로 대입\r\n");
      out.write("\t$frm.find(\"#memberId_\").val('");
      out.print( memberId);
      out.write("');\r\n");
      out.write("\t// 2. idValid의 값을 1로 바꿔줌\r\n");
