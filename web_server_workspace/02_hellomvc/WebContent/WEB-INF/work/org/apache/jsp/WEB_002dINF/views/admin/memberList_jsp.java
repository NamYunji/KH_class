 ...
 * Generated at: 2021-04-06 10:45:06 UTC
...
public final class memberList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1617610068084L));
 ...
 if(loginMember != null && MemberService.ADMIN_ROLE.equals(loginMember.getMemberRole())){ 
	...
	String kw = request.getParameter("searchKeyword"); 
      ...
      out.write("/* memberId를 기본값으로 사용하기 위해 type==null일 경우도 추가 */\r\n");
 ...
 if (list == null || list.isEmpty()) {
      ...
      out.write("/* SEARCH BAR */\r\n");
      out.write("/**\r\n");
      out.write(" * #searchType이 변경되면, 해당 form이 노출되어야 한다.\r\n");
      out.write(" */ \r\n");
      out.write("$(searchType).change(function(){\r\n");
      out.write("\t// searchType의 value값을 보면 뭘 선택했는지 확인할 수 있음\r\n");
      out.write("\tvar searchTypeVal = $(this).val();\r\n");
      out.write("\r\n");
      out.write("\t$(\".search-type\")\r\n");
      out.write("\t\t.hide() // 모든 div를 다 감추고 \r\n");
      out.write("\t\t.filter(\"#search-\" + searchTypeVal) // 해당 선택자와 일치하는 것을 찾음\r\n");
      out.write("\t\t.css(\"display\", \"inline-block\"); // 그것의 display를 inline-block으로 바꾸기\r\n");
      out.write("});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("\t\t</section>\r\n");
