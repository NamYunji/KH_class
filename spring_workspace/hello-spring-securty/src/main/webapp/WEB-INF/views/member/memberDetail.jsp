...
if(member != null){
	...
	System.out.println(hobbyList.contains("등산"));
}
%>
...
<div id="update-container">
	<form:form name="memberUpdateFrm" action="${pageContext.request.contextPath}/member/memberUpdate.do" method="post">
		...
		<input type="date" class="form-control" placeholder="생일" name="birthday" id="date" value="<sec:authentication property='principal.name'/>"/>
		...
		<!-- el안에서 security태그 사용 불가
			 -> principal을 변수로 선언해두기  -->
