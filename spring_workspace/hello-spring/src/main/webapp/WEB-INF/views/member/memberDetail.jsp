...
<%
	/* contains메소드를 사용하기 위해 list로 변환 */
	String[] hobby = ((Member)session.getAttribute("loginMember")).getHobby();
	// hobby가 null이 아닐때만 list로 변환, null일 경우 nullPointerException이 발생하는 것을 방지
